...
Note : le workspace a ete fusionne. Le projet iOS Capacitor est maintenant dans
`ios/App` du dossier `ma-voix-windows`.
...
actuelle est le module Android natif `android/aidant`.
